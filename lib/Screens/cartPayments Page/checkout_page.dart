...
import 'package:flutter_e_commerce_app/Screens/cartPayments%20Page/shipping_address.dart';
...
class CheckoutPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<QuantityBloc,QuantityState>(
        ...
        builder: (context, state) =>  Padding(
          ...
          child: Column(
            children: [
              Expanded(
                flex:1,
                child: Align(alignment: Alignment.centerLeft,child: Text("Shipping Address",style: GoogleFonts.anta(fontSize: 20),))
              ),
              Container(
                height: 1,
                                    ...
                                    Expanded(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Expanded(flex: 2,child: Align(alignment: Alignment.center,child: IconButton(onPressed: (){
              ...
              Expanded(flex: 1,child: Align(alignment: Alignment.bottomLeft,child: Text("Order list", style: GoogleFonts.anta(fontSize:20),))),
              Expanded(flex:5,child: ListView.builder(itemCount:products.length ,itemBuilder: (parent, index)=>
